--[[
	Combined load test exercising ALL services through the WebUI.
	The WebUI fans out to persistence, auth, image, and recommender
	internally, so every cycle stresses the full stack.
--]]

prefix = "https://debian.tail4a3387.ts.net/tools.descartes.teastore.webui/"
productviewcount = 30
postIndex = {3, 11}
